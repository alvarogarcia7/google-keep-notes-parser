...
INPUT_TOPIC = "messages.10.raw.type.googlenotes"
OUTPUT_TOPIC = "messages.20.googlenotes"
...
async def main() -> None:
    """Subscribe to messages.10.raw.type.googlenotes and route to messages.20.googlenotes."""
    nc = await _connect_with_retry(NATS_URL)

    print(f"🔄 Google Notes Router started")
    ...
    try:
        async def handler(msg):
            try:
                ...
                await route_google_notes(message_data, nc)
